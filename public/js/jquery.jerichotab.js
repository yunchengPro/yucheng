...
$.extend($.fn, {
    initJerichoTab: function(setting) {
        ...
        $.fn.jerichoTab.resize = function() {
            ...
            $('#jerichotab_contentholder').height($(opts.renderTo).height() - 0);
            $('#jerichotab_contentholder iframe').height($(opts.renderTo).height() - 30);
        };
    ...
    buildIFrame: function(src) {
        return this.each(function() {
            ...
            var iframe = $('<iframe id="' + jerichotabiframe + '" name="' + jerichotabiframe + '" src="' + src + '" frameborder="0" scrolling="auto" />')
                                        .css({ width: '100%', height: $(this).parent().height()- 30, border: 0 })
                                            .appendTo($(this));
