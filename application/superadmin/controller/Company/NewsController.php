...
class NewsController extends ActionController{
    ...
    public function articlelistAction(){
        ...
        $topcate = Model::ins('ComNewsCategory')->getList(['parentid'=>6,'isdelete'=>0],'id,categoryname');
    ...
    public function addarticleAction(){
        ...
        $action = '/Company/News/doaddoreditarticle';

        $topcate = Model::ins('ComNewsCategory')->getList(['parentid'=>1,'isdelete'=>0],'id,categoryname');
        ...
        $formtoken = $this->Btoken('Company-News-addarticle');
        $viewData = [
            'formtoken'=>$formtoken,
            'action' => $action ,
            'topCategory' => $topCategory
    ...
    public function editarticleAction(){
        ...
        $formtoken = $this->Btoken('Company-News-editarticle');
        $viewData = [
            'formtoken'=>$formtoken,
            'action' => $action ,
            'topCategory' => $topCategory,
