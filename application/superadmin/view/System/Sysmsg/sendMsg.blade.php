...
<?php 
    ...
    */
    ...
    $field = array(
            "title"=>array("type"=>"text","name"=>"消息标题","validator"=>"required:true","value"=>$msg['title']),
            "imageUri"=>array("type"=>"imgupload","name"=>"图片地址","value"=>$msg['imageUri']),
            "content"=>array("type"=>"textarea","name"=>"消息内容","value"=>$msg['content']),
            "urltype"=>array("type"=>"select","name"=>"跳转类型","value"=>$msg['urltype'],'option'=>['1' => '原生app', '2'=>'H5','3' => '牛掌柜', '4'=>'牛商','5'=>'无连接']),
            "url"=>array("type"=>"text","name"=>"跳转链接","value"=>$msg['url']),
            "id"=>array("type"=>"hidden","name"=>"消息id","value"=>$msg['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
