...
<?php 
    ...
    */
    ...
    $field = array(
            "title"=>array("type"=>"text","name"=>"版本标题","validator"=>"required:true","value"=>$version['title']),
            "type"=>array("type"=>"select","name"=>"系统类型","value"=>$version['type'],"option"=>["1"=>"IOS","2"=>"Android"]),
            "content"=>array("type"=>"edit","name"=>"内容介绍","value"=>$version['content'],"validator"=>"required:true"),
            "version"=>array("type"=>"text","name"=>"版本号","validator"=>"required:true","value"=>$version['version']),
            "sort"=>array("type"=>"text","name"=>"排序","validator"=>"required:true","value"=>$version['sort']),
            "id"=>array("type"=>"hidden","name"=>"id","value"=>$version['id']),
            "submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
