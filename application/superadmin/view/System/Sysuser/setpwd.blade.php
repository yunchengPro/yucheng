...
<?php 
    ...
    */
    ...
    $field = array(
            ...
            "pwd1"=>array("type"=>"password","name"=>"新密码","validator"=>"required:true","value"=>''),
            "pwd2"=>array("type"=>"password","name"=>"重复密码","validator"=>"required:true","value"=>''),
            "userid"=>array("type"=>"hidden","name"=>"用户id","value"=>$userid),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
