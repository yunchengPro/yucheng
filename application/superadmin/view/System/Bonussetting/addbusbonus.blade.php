...
<?php 
    ...
    */
    ...
    $field = array(
            "role"=>array("type"=>"data","name"=>"用户角色","validator"=>"required:true","value"=>'商家','data'=>'商家'),
            "adddate"=>array("type"=>"time","name"=>"分红日期","validator"=>"required:true","value"=>$bonus_bus['adddate']),
            "proportion"=>array("type"=>"text","name"=>"分红比例","validator"=>"required:true","value"=>$bonus_bus['proportion'],'append_str'=>'单位%,如70%，填写70'),
            "id"=>array("type"=>"hidden","value"=>$bonus_bus['id'])
        );
