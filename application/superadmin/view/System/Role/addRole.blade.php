...
<?php 
    ...
    */
    ...
    $field = array(
            "name"=>array("type"=>"text","name"=>"角色名称","validator"=>"required:true","value"=>$role['name']),
            "remark"=>array("type"=>"text","name"=>"角色描述","validator"=>"required:true","value"=>$role['remark']),
            "enable"=>array("type"=>"select","name"=>"启用状态","value"=>$role['role'],'option'=>['0'=>'停用','1'=>'启用']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
