    ...
    */
    ...
    //系统三级菜单
   	...
   	foreach($pagelist as $key=>$row){
        ...
        //  $pagelist[$key]['act'][]= array("type"=>"newpage","name"=>"button","value"=>"禁用","_width"=>"500","_height"=>"400","_title"=>"移除","_url"=>"#".Encode($row['id']));

        $pagelist[$key]['act'][]= array("type"=>"confirm","name"=>"button","value"=>"移除","_width"=>"500","_height"=>"400","_title"=>"移除","_url"=>"/System/Role/disrole?userid=".Encode($row['id']));
    ...
    $button = array(
        "bt1"=>array("type"=>"popup_listpage","name"=>"button","value"=>"添加用户","_width"=>"650","_height"=>"500","_title"=>'添加用户',"_url"=>"/System/Role/choseuser?roleid=".$roleid),
