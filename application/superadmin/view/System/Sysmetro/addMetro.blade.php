...
<?php 
    ...
    */
    ...
    $field = array(
            ...
            "linename"=>array("type"=>"text","name"=>"线路名称","validator"=>"required:true", "value"=>$Metro['linename']),
            "areaid"=>array("type"=>"selectpicker", "name"=>"所属区域", 'option' => $city, "value"=>$Metro['areaid']),
            "linename"=>array("type"=>"text","name"=>"线路名称","validator"=>"required:true", "value"=>$Metro['linename']),
            "metroname"=>array("type"=>"text","name"=>"地铁名称","validator"=>"required:true", "value"=>$Metro['metroname']),
            "pinyin"=>array("type"=>"text", "name"=>"地铁名称首拼", "value"=>$Metro['pinyin']),
            "sort"=>array("type"=>"text","name"=>"排序","validator"=>"required:true", "value"=>$Metro['sort']),
            "id"=>array("type"=>"hidden","value"=>$Metro['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
