...
use app\lib\Db;
    ...
    */
    $list_set = array(
        ...
        "rolename"=>array("name"=>"粉丝名称"),
        //"username"=>array("name"=>"用户名"),
        "usercount"=>array("name"=>"粉丝人数（人）"),
        "useramount" => array("name"=>"粉丝收益（元）"),
    ...
    */
    foreach($pagelist as $key=>$row){
        $pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"查看", "_width"=>"1100","_height"=>"600","_title"=>"查看","_url"=>"/Amount/User/userlist?userid=".$userid."&roletype=".$row['roletype']."&role=".$role);
//         $pagelist[$key]['act'][]= array("type"=>"newpage","name"=>"button","value"=>"查看", "_width"=>"500","_height"=>"450","_title"=>"查看","_url"=>"/Amount/User/userlist?userid=".$userid."&roletype=".$row['roletype']."&role=".$role);
