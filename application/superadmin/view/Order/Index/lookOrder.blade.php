...
<div class="page-container addOrder">
	...
	<div class="remark">
		...
		<span class="f-16" style="color: #F13437"><?=$logisticsData['leavemessage']?></span>
	</div>
	 -->
	...
	<?php if($orderData['orderstatus'] > 0) { // 已经付款(付款信息) ?>
		...
		<div class="f-16">
			<ul>
				<!-- 
				<li><span>支付方式：</span><span class="c-666"><?=$payArr[$payData['pay_type']]?></span></li>
				 -->
				<li><span>支付方式：</span><span class="c-666">
				<?php 
				if(!empty($payData))
				    echo $payData['pay_type'] != '' ? $payArr[$payData['pay_type']] : '余额支付';
// 					echo $payData['pay_type']!=''?$payData['pay_type']:'余额支付';
				else
					echo "未支付";
				?>
				</span></li>
...
<!--     			<ul> -->
<!--     				<li><span>快递公司：</span><input type="text" class="input-text width250 " name="express_name" id="express_name"></li> -->
