...
//        $pagelist[$key]['businessid'] = Db::Model("BusBusiness")->getRow(['id'=>$row['businessid']],'businessname')['businessname'];
        ...
        $pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"编辑","_width"=>"650","_height"=>"550","_title"=>"编辑","_url"=>"/Customer/BullPeo/editBullPeoInfo?id=".Encode($row['id']));
...
//         $pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"查看用户关系","_width"=>"650", "_height"=>"550", "_title"=>"查看用户关系","_url"=>"/Customer/BullCus/userRoleRelation?id=".Encode($row['id']));
        ...
        $pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"粉丝", "_width"=>"1000","_height"=>"650","_title"=>"粉丝","_url"=>"/Customer/BullCus/userFans?role=2&id=".Encode($row['id']));
    ...
    */
    ...
    //自动生成按钮
//     $button = array(
//             "bt1"=>array("type"=>"popup_listpage","name"=>"button","value"=>"添加用户角色","_width"=>"550","_height"=>"450","_title"=>'添加用户角色',"_url"=>"/Customer/BullPeo/addBullPeoInfo"),
//         );
