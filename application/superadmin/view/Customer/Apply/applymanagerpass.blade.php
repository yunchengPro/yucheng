...
<?php 
    ...
    */
    ...
    $field = array(
            "name"=>array("type"=>"data","name"=>"姓名","validator"=>"required:true","data"=>$apply_manager['name']),
            "mobile"=>array("type"=>"data","name"=>"联系电话","validator"=>"required:true","data"=>$apply_manager['mobile']),
