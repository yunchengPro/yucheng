...
<?php 
    ...
    */
    ...
    $field = array(
            "name"=>array("type"=>"text","name"=>"姓名","validator"=>"required:true","value"=>$apply_bus['name']),
            "mobile"=>array("type"=>"text","name"=>"联系电话","validator"=>"required:true","value"=>$apply_bus['mobile']),
            "area"=>array("type"=>"area","name"=>"所在地区","validator"=>"required:true","value"=>$apply_bus['area_code']),
            "address"=>array("type"=>"text","name"=>"详细地址","validator"=>"required:true","value"=>$apply_bus['address']),
            "id"=>array("type"=>"hidden","value"=>$apply_bus['id'])
        );
