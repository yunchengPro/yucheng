...
<?php 
    ...
    */
    ...
    $field = array(
            "name"=>array("type"=>"data","name"=>"姓名","validator"=>"required:true","data"=>$apply_bus['name']),
            "mobile"=>array("type"=>"data","name"=>"联系电话","validator"=>"required:true","data"=>$apply_bus['mobile']),
            "area"=>array("type"=>"data","name"=>"所在地区","validator"=>"required:true","data"=>$apply_bus['area']),
            "address"=>array("type"=>"data","name"=>"详细地址","validator"=>"required:true","data"=>$apply_bus['address']),
            "join_type"=>array("type"=>"data","name"=>"加盟方式","validator"=>"required:true","data"=>$apply_bus['join_type']),
            "remark"=>array("type"=>"textarea","name"=>"审核说明","validator"=>"required:true","value"=>$apply_bus['remark']),
