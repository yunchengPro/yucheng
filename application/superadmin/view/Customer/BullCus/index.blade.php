...
//        $pagelist[$key]['businessid'] = Db::Model("BusBusiness")->getRow(['id'=>$row['businessid']],'businessname')['businessname'];
        ...
        $pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"编辑","_width"=>"650","_height"=>"550","_title"=>"编辑","_url"=>"/Customer/BullCus/editCusCustomerInfo?id=".Encode($row['id']));
...
//         $pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"查看用户关系", "_width"=>"650","_height"=>"550","_title"=>"查看用户关系","_url"=>"/Customer/BullCus/userRoleRelation?id=".Encode($row['id']));
        ...
        $pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"粉丝", "_width"=>"1000","_height"=>"650","_title"=>"粉丝","_url"=>"/Customer/BullCus/userFans?role=1&id=".Encode($row['id']));
        
        $pagelist[$key]['act'][]= array("type"=>"confirm","name"=>"button","value"=>"禁用","_width"=>"500","_height"=>"200","_title"=>'是否确定禁用该用户?',"_url"=>"/Customer/BullCus/enable?enable=-1&id=".Encode($row['id']));
