...
//         "role_enable"=>array("name"=>"角色状态", 'data_arr' => ['1' => '启用', '2'=>'禁用']),
    ...
    */
    foreach($pagelist as $key=>$row){
        ...
        $pagelist[$key]['act'][]= array("type"=>"confirm","name"=>"button","value"=>"启用","_width"=>"500","_height"=>"200","_title"=>'是否确定启用该用户?',"_url"=>"/Customer/BullCus/enable?enable=1&id=".Encode($row['id']));
