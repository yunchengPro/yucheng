...
// 	    "areaname" => array("name" => "地区名称"),
	...
	foreach ($pagelist as $key => $row) {
	    ...
	    $pagelist[$key]['act'][] = array("type" => "popup_listpage", "name" => "button", "value" => "审核失败", "_width" => "650", "_height" => "550", "_title" => "拒绝说明", "_url" => "/Customer/BullBus/examFail?status=3&id=".Encode($row['id']));
