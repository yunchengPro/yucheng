...
<?php 
    ...
    */
    ...
    $field = array(
            "businessname"=>array("type"=>"text","name"=>"品牌名称","validator"=>"required:true","value"=>$business['businessname']),
            "businesslogo"=>array("type"=>"imgupload","name"=>"品牌logo","validator"=>"required:true","value"=>$business['businesslogo']),
            "realname"=>array("type"=>"text","name"=>"负责人姓名","value"=>$business['realname']),
            "idnumber"=>array("type"=>"text","name"=>"身份证号码","validator"=>"required:true","value"=>$business['idnumber']),
            ...
            "address"=>array("type"=>"text","name"=>"商家地址","validator"=>"required:true","value"=>$business['address']),
            "description"=>array("type"=>"edit","name"=>"商家详细介绍","validator"=>"required:true","value"=>$business['description']),
