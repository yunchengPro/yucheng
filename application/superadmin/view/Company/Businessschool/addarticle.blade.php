...
<?php 
    ...
    */
    ...
    $field = array(
            "title"=>array("type"=>"text", "name"=>"文章标题","value"=>$Article['title'],'other'=>'style="width:800px;"'),
            "categoryid"=>array("type"=>"select","name"=>"选择分类","validator"=>"required:true", "option"=>$topCategory,'value'=>$Article['categoryid']),
            "thumb"=>array("type"=>"imgupload", "name"=>"缩略图", "value"=>$Article['thumb']),
            "keywords"=>array("type"=>"text","name"=>"关键词","value"=>$Article['keywords']),
            "description"=>array("type"=>"textarea","name"=>"描述","value"=>$Article['description']),
            "content"=>array("type"=>"edit","name"=>"内容","value"=>$Article['content']),
            "author"=>array("type"=>"text","name"=>"作者","value"=>$Article['author']),
            "sort"=>array("type"=>"text","name"=>"排序","value"=>$Article['sort']),
            "id"=>array("type"=>"hidden","value"=>$Article['id']),
            "submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
