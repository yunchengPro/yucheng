...
<?php 
    ...
    */
    ...
    $field = array(
            "parentid"=>array("type"=>"select", "name"=>"上级分类", 'option' => $topCategory, "value"=>$Category['parentid']),
            "categoryname"=>array("type"=>"text","name"=>"分类名称","validator"=>"required:true", "value"=>$Category['categoryname']),
            "category_icon"=>array("type"=>"imgupload", "name"=>"分类图片", "value"=>$Category['category_icon']),
            "sort"=>array("type"=>"text","name"=>"排序","validator"=>"required:true", "value"=>$Category['sort']),
