...
use app\lib\Db;
    ...
    */
    $list_set = array(
        ...
        "parentid"=>array("name"=>"上级分类"),
        "category_icon"=>array("name"=>"图标"),
        "sort"=>array("name"=>"排序","data_sort"=>true,"_url"=>"/Company/Article/sortcategory",'sort'=>true),
        "act"=>array("name"=>"操作"),
    );
    ...
    */
    foreach($pagelist as $key=>$row){
        ...
        $pagelist[$key]['act'][]= array("type"=>"popup","name"=>"button","value"=>"修改","_width"=>"500","_height"=>"400","_title"=>"修改<font color='green'>".$row['categoryname']."</font>","_url"=>"/Company/Article/editcategory?id=".Encode($row['id']));

       
        
        $pagelist[$key]['act'][]= array("type"=>"confirm","name"=>"button","value"=>"删除","_width"=>"500","_height"=>"400","_title"=>"确定删除?","_url"=>"/Company/Article/delcategory?ids=".Encode($row['id']));
    ...
    */
    ...
    //自动生成按钮
    $button = array(
            "bt1"=>array("type"=>"popup_listpage","name"=>"button","value"=>"添加分类","_width"=>"600","_height"=>"450","_title"=>'添加分类',"_url"=>"/Company/Article/addcategory"),
