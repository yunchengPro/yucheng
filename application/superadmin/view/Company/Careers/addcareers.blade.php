...
<?php 
    ...
    */
    ...
    $field = array(
            "position"=>array("type"=>"text","name"=>"招聘职位","value"=>$careers['position'],"validator"=>"required:true"),
            "position_en"=>array("type"=>"text","name"=>"英文描述",'value'=>$careers['position_en']),
            "responsibility"=>array("type"=>"edit", "name"=>"岗位职责", "value"=>$careers['responsibility']),
            "requirement"=>array("type"=>"edit","name"=>"任职要求","value"=>$careers['requirement']),
            "sort"=>array("type"=>"text","name"=>"排序","value"=>$careers['sort']),
            "id"=>array("type"=>"hidden","value"=>$careers['id']),
            "submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
