...
use app\lib\Db;
    ...
    */
    $list_set = array(
        ...
        "sort"=>array("name"=>"排序","data_sort"=>true,"_url"=>"/Company/Servicecon/sortarticle",'sort'=>true),
    ...
    */
    foreach($pagelist as $key=>$row){
        ...
        $pagelist[$key]['act'][]= array("type"=>"newpage","name"=>"button","value"=>"修改","_width"=>"500","_height"=>"400","_title"=>"修改<font color='green'>".$row['title']."</font>","_url"=>"/Company/Servicecon/editarticle?id=".Encode($row['id'])."&categoryid=".$categoryid);

        $pagelist[$key]['act'][]= array("type"=>"confirm","name"=>"button","value"=>$str,"_width"=>"500","_height"=>"400","_title"=>"确定".$str."?","_url"=>"/Company/Servicecon/setarticletop?ids=".Encode($row['id'])."&type=".$type);
        
        $pagelist[$key]['act'][]= array("type"=>"confirm","name"=>"button","value"=>"删除","_width"=>"500","_height"=>"400","_title"=>"确定删除?","_url"=>"/Company/Servicecon/delarticle?ids=".Encode($row['id']));
    ...
    */
    ...
    //自动生成按钮
    $button = array(
            "bt1"=>array("type"=>"newpage","name"=>"button","value"=>"添加".$addcate."新闻","_width"=>"600","_height"=>"450","_title"=>'添加'.$addcate.'新闻',"_url"=>"/Company/Servicecon/addarticle?categoryid=".$categoryid),
