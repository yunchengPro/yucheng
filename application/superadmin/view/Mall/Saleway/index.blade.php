...
use app\lib\Db;
    ...
    */
    foreach($pagelist as $key=>$row){
        ...
        $pagelist[$key]['act'][]= array("type"=>"newpage","name"=>"button","value"=>"编辑","_width"=>"550","_height"=>"450","_title"=>"编辑","_url"=>"/Mall/Saleway/editSaleway?id=".Encode($row['id']));

        $pagelist[$key]['act'][]= array("type"=>"confirm","name"=>"button","value"=>"删除","_width"=>"500","_height"=>"200","_title"=>'是否确定删除该记录?',"_url"=>"/Mall/Saleway/delSaleway?ids=".Encode($row['id']));
    ...
    */
    ...
    //自动生成按钮
    $button = array(
            "bt1"=>array("type"=>"popup_listpage","name"=>"button","value"=>"添加快捷方式","_width"=>"550","_height"=>"450","_title"=>'添加快捷方式',"_url"=>"/Mall/Saleway/addSaleway"),

            "bt2"=>array("type"=>"confirm_all","name"=>"button","value"=>"批量删除","_width"=>"500","_height"=>"200","_title"=>'删除选中项?',"_url"=>"/Mall/Saleway/delSaleway?rel=delete")
        );
