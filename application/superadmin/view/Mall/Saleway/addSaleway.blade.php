...
<?php 
    ...
    */
    ...
    $field = array(
            "type"=>array("type"=>"select", "name"=>"类型", 'option' => ['1' => '商城首页', '2'=>'现金专区', '3'=>'现金加牛币专区'], "validator"=>"required:true", "value"=>$salewayData['type']),
            "name"=>array("type"=>"text","name"=>"快捷方式名称","validator"=>"required:true", "value"=>$salewayData['name']),
            "thumb"=>array("type"=>"imgupload", "name"=>"图片地址","validator"=>"required:true", "value"=>$salewayData['thumb']),
            "urltype"=>array("type"=>"select", "name"=>"跳转类型", 'option' => $skipurl,"validator"=>"required:true", "value"=>$salewayData['urltype']),
            "url"=>array("type"=>"text","name"=>"跳转链接","validator"=>"required:true", "value"=>$salewayData['url']),
            "sort"=>array("type"=>"text","name"=>"排序","validator"=>"required:true", "value"=>$salewayData['sort']),
            "id"=>array("type"=>"hidden","value"=>$salewayData['id']),
            "submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
