...
<?php 
    ...
    */
    ...
    $field = array(
            "parentid"=>array("type"=>"select","name"=>"上级分类","option"=>$StoCategory,"value"=>$localStoCategory['parentid']),
            "categoryname"=>array("type"=>"text","name"=>"分类名称","validator"=>"required:true","value"=>$localStoCategory['categoryname']),
            "sort"=>array("type"=>"text","name"=>"排序","value"=>$localStoCategory['sort'],"validator"=>"required:true"),
            "category_icon"=>array("type"=>"imgupload","name"=>"分类图标","value"=>$localStoCategory['category_icon']),
            "id"=>array("type"=>"hidden","value"=>$localStoCategory['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
