...
<?php 
    ...
    */
    ...
    $field = array(
            "type"=>array("type"=>"select", "name"=>"类型", 'option' => ['1' => '头部', '2'=>'中间', '3'=>'底部'], "validator"=>"required:true", "value"=>$StobannerData['type']),
            "bname"=>array("type"=>"text","name"=>"banner名称","validator"=>"required:true", "value"=>$StobannerData['bname']),
            "thumb"=>array("type"=>"imgupload", "name"=>"图片地址","validator"=>"required:true", "value"=>$StobannerData['thumb']),
            "city_id"=>array("type"=>"selectpicker", "name"=>"所属区域", 'option' => $city, "value"=>$StobannerData['city_id']),
            "urltype"=>array("type"=>"select", "name"=>"跳转类型", 'option' => $skipurl,"validator"=>"required:true", "value"=>$StobannerData['urltype']),
            "url"=>array("type"=>"text","name"=>"跳转链接","validator"=>"required:true", "value"=>$StobannerData['url']),
            "sort"=>array("type"=>"text","name"=>"排序","validator"=>"required:true", "value"=>$StobannerData['sort']),
            "id"=>array("type"=>"hidden","value"=>$StobannerData['id']),
            "submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
