...
<?php 
    ...
    */
    ...
    $field = array(
            "type"=>array("type"=>"select", "name"=>"类型", 'option' => ['1' => '商城首页', '2'=>'现金专区', '3'=>'现金加牛币专区'], "validator"=>"required:true", "value"=>$moduleData['type']),
            "modulename"=>array("type"=>"text","name"=>"模块名称","validator"=>"required:true", "value"=>$moduleData['modulename']),
            "modulecode"=>array("type"=>"text","name"=>"模块编码","validator"=>"required:true", "value"=>$moduleData['modulecode']),
            "module_type"=>array("type"=>"select", "name"=>"布局类型", 'option' => ['1' => '布局1', '2'=>'布局2', '3'=>'布局3', '4'=>'布局4', '5'=>'布局5', '6'=>'布局6'],"validator"=>"required:true", "value"=>$moduleData['module_type']),
            "isshow"=>array("type"=>"select", "name"=>"是否显示", 'option' => ['1' => '显示', '-1'=>'不显示'],"validator"=>"required:true", "value"=>$moduleData['isshow']),
            "sort"=>array("type"=>"text","name"=>"排序","validator"=>"required:true", "value"=>$moduleData['sort']),
            "id"=>array("type"=>"hidden","value"=>$moduleData['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
