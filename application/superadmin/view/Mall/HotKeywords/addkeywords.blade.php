...
<?php 
    ...
    */
    ...
    $field = array(
            "type"=>array("type"=>"select", "name"=>"类型", 'option' => ['1' => '牛店页面', '2'=>'牛品页面'], "validator"=>"required:true", "value"=>$keywordsData['type']),
            "name"=>array("type"=>"text","name"=>"输入框热词", "value"=>$keywordsData['name']),
            "keywords"=>array("type"=>"textarea", "name"=>"列表热词", "value"=>$keywordsData['keywords'],'append_str'=>"多个热词用逗号隔开,最多10个"),
            "id"=>array("type"=>"hidden","value"=>$keywordsData['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
