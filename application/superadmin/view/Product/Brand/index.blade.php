...
use app\lib\Db;
    ...
    */
    $list_set = array(
        ...
        "brandname"=>array("name"=>"品牌名称",),
        "brandlogo"=>array("name"=>"品牌图标",'thumb'=>["width"=>150,"height"=>50]),
        "sort"=>array("name"=>"排序","data_sort"=>true,"_url"=>"/Product/Brand/sort"),
    ...
    */
    foreach($pagelist as $key=>$row){
        ...
        $pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"编辑","_width"=>"550","_height"=>"450","_title"=>"编辑品牌","_url"=>"/Product/Brand/editBrand?id=".Encode($row['id']));

        $pagelist[$key]['act'][]= array("type"=>"confirm","name"=>"button","value"=>"删除","_width"=>"500","_height"=>"200","_title"=>'是否确定删除该记录?',"_url"=>"/Product/Brand/delBrand?ids=".Encode($row['id']));
    ...
    */
 	$search = array(
        "brandname"=>array("type"=>"text","name"=>"品牌名称/关键字","value"=>"")
    );
