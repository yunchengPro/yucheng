...
<?php 
    ...
    */
    ...
    $field = array(
            ...
            "name"=>array("type"=>"text","name"=>"分类名称","validator"=>"required:true","value"=>$localCategory['name']),
            "status"=>array("type"=>"select","name"=>"状态","value"=>$localCategory['status'],"option"=>['1'=>'启用','-1'=>'禁用']),
            "category_icon"=>array("type"=>"imgupload","name"=>"分类图标","value"=>$localCategory['category_icon']),
