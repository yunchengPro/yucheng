...
<?php 
    ...
    */
    ...
    $field = array(
            "stateremark"=>array("type"=>"textarea","name"=>"違規下架理由","validator"=>"required:true","value"=>''),
            "paramString"=>array("type"=>"hidden","value"=>$paramString),
            "goodsid"=>array("type"=>"hidden","value"=>$goodsid),
        );
