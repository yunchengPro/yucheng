...
<?php 
    ...
    */
    ...
    $field = array(
            "categoryname"=>array("type"=>"text","name"=>"分类名称","validator"=>"required:true","value"=>$Category['categoryname']),
            "enable"=>array("type"=>"select","name"=>"启用状态","validator"=>"required:true","value"=>$Category['enable'],"option"=>$enable_arr),
            "category_icon"=>array("type"=>"imgupload","name"=>"分类图标","value"=>$Category['category_icon']),
            "sort"=>array("type"=>"text","name"=>"排序","validator"=>"","value"=>$Category['sort']),
            "catetype"=>array("type"=>"hidden","value"=>$type),
            "id"=>array("type"=>"hidden","value"=>$Category['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
