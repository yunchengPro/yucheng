...
{include file="Pub/header" /}
	...
	<div class="mall-good-caetes">
		...
		<div class="cate " :id="'cate-'+category.id" :data-key="category.id" v-for="category in categorylist">
			<span class="tl-ellipsis" v-html="category.name"></span>
		</div>
		...
		<div class="right-content">
			<div id="mainwrap">
				<div class="foodlistwrap" style="transform: translate(0px, 0px) translateZ(0px);"  >
					<!--分类商品-->
					<div class="one-class" :id="'list-'+category.id" :data-tagid="category.id" v-for="category in categorylist">
						<div class="cate-name">
							<h4 v-html="category.name"></h4>
						</div>
						<div class="cate-list-wrap">
							<div class="tl-grid">
								<div class="tl-grid-1-3" v-for="child in category.child">
									<a href="#">
   ...
   new Vue({
    ...
    methods:{
        getcategorylist:function(){
            ...
            _this.$http.post('/product/index/getcategorylist',{
