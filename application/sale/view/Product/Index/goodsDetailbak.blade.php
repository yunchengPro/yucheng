{include file="Pub/header" /}
   ...
   <!--          <div class="pro-detail-item">
        ...
        <div class="am-modal-actions" id="my-actions">
            ...
            <div class="am-modal-actions-group">
                <a href="" class="am-btn am-btn-secondary am-btn-block">确 定</a>
            </div>
        </div>
...
.pro-detail-bar .back{
    background: url(../../img/icon/back_bg@2x.png) no-repeat;
    background-size:100% ;
    width: 29px;
    height: 29px;
    display: block;
...
.pro-detail-bar .buycard{
    background: url(../../img/icon/buycar_bg@2x.png) no-repeat;
    background-size:100% ;
    width: 29px;
    height: 29px;
    display: block;
...
.reward-bar{
    position: absolute;
    bottom: 0;
    background: url(../../img/icon/rewrad-2.png) no-repeat;
    background-size:100% ;
    height: 40px;
    width: 100%;
    z-index: 20;
...
.detail-footer .collect{
    ...
    background: url(../../img/icon/star@2x.png) no-repeat;
    background-size:100% ;
}
