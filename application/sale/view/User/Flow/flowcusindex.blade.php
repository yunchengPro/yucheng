	...
	<header class="deal-header">	
		<div class="page-bar">
			...
			<div class="filter-list" id="filter-list">
				...
				-->
				<div class="filter-item" v-for="screen in screens">
					<span v-html="screen.text" @click="getScreen(screen.value)"></span>
				</div>
			</div>
		</div>
	</header>
    ...
    var Vm = new Vue({
        ...
        methods:{
            ...
            getflowcusData:function(){
                var _this = this;
                _this.current = _this.type-1;
                _this.$http.post(_this.apiUrl,{
                    type:_this.type,screen:_this.screenselected,begintime:_this.begintime,endtime:_this.endtime,page:_this.page,
                }).then(
                    function(res){
                        data = cl(res);
                        if(data.code == "200") {
