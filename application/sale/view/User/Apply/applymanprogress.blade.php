...
<header class="page-header">
		...
		<div class="bar-title">申请区代理进度</div>
...
<section class="apply-progress">
	...
	<div class="apply-tip" v-if="orderDetail.status == 1">您已成功提交申请，正在审核中……</div>
	...
	<div class="apply-items">
		...
		<div class="item">
			<div class="item-l">
				<i class="point-df"       v-if="orderDetail.status != 2"></i>
				<div class="line-df-half"  v-if="orderDetail.status != 2"></div>
				<i class="point-suc"       v-if="orderDetail.status == 2"></i>
				<div class="line-sucs-half" v-if="orderDetail.status == 2"></div>

			</div>
			<div class="item-r">

				<div class="f-14"  >申请成功</div>
...
<style>
	...
	.apply-items>.item>.item-l>.line-sucs-half {
	    height: 22px;
	    width: 1px;
	    background: #CEA15A;
	    position: absolute;
                    ...
                    function (res) {
                        ...
                        if(data.code=='200'){
                        	...
                        	_this.orderDetail = data.data;
                       		...
                       		toast(data.msg);
                       		window.location.href = '/user/apply/applyToManager';
                       	}
                        //$("#city").val('');
                    },function (res) {
                        // 处理失败的结果
