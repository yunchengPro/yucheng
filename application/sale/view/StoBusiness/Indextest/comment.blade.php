...
<head>
    ...
    <style type="text/css">
            ...
            .one-upload .close{
                ...
                height: 13px;
                position: absolute;
                background: url(/mobile/img/icon/close.png) 0 -13px no-repeat;
                background-size: 100%;
                z-index: 10;
                right: 0;
                top: -5px;
       ...
       <div class="am-g baguetteBox">
           ...
           <!--   <div class="am-u-sm-12">
                ...
                <div class="am-u-sm-4 one-upload">
                    <i class="close"></i>
                   <a href="#"><img src="/mobile/img/quilt-1.png" /></a> 
                </div>
               <div class="am-u-sm-4 one-upload">
                    <i class="close"></i>
                    <a href="#"><img src="/mobile/img/quilt-2.png" /></a>
                </div>
                <div class="am-u-sm-4 one-upload">
                   <i class="close"></i>
                    <a href="#"><img src="/mobile/img/quilt-3.png" /></a>
                </div>
                <div class="am-u-sm-4 one-upload">
                     <i class="close"></i>
                    <a href="#"><img src="/mobile/img/quilt-1.png" /></a>
            ...
            <div class="button-group button-group-small radio">   
                ...
                <script type="text/javascript">
                    fileupload('photos','{"url":"\/uploadfile\/jqueryfileupload.php","domain":"\/\/nnhcoupon.oss-cn-shenzhen.aliyuncs.com\/","maxFileSize":4194304,"maxNumberOfFiles":5,"savefileurl":"\/Sys\/upload\/getfile","getParamUrl":"\/Sys\/upload\/policy","server_type":"NNH\/images","formData":{"server_type":"NNH\/images"}}');
                </script>
            </div>
    ...
    $(function(){
        ...
        $(".am-btn-block").on("click",function(){
            ...
            var shopid = '<?=$order_row['businessid']?>';
             //提交订单
            $.get("/StoBusiness/Indextest/doAddComment?orderno=<?=$order_row['pay_code']?>&customerid=<?=$order_row['customerid']?>&content="+content + "&scores=" + scores + "&photos=" + photos, function(data){
                    //alert('评价成功');
                     layer.open({
                            content: '评价成功',
                            skin: 'msg',
