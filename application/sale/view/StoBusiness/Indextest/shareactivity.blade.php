...
<style>
	.activity-desc-bg{
		background: url(/mobile/img/icon/activity_bg.png) center no-repeat;
...
<body class="activity-desc-bg">
   ...
   <section class="activity-desc-wrap">
   		<div><img src="/mobile/img/icon/activity_title.png"/></div>
   			<h4>成功注册即享优惠</h4>

		<div class="activity-item">1、牛票专区购物，买多少送多少；</div>
		
		<div class="activity-item">2、成功邀请一个好友注册可获得价值10元的牛豆；</div>
