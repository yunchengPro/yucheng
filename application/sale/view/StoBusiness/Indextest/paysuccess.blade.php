...
<head>
    ...
    <style>
        .c-333{color: #333333}
        .fav {background: url(/mobile/img/icon/tag.png) 50% no-repeat; background-size: 100%;
...
<body>
    ...
    <div class="pay-success-container" style="display:none;">
       ...
       <!--  <div class="suc-tip">
        ...
        <div class="suc-oper">
            <a href="/StoBusiness/Indextest/shareactivity" class="oper-btn">分享</a>
            <a href="/StoBusiness/Indextest/comment?orderno=<?=$orderno?>" class="oper-btn">评价</a>
        </div>
    </div>
...
<!--    <div class="pay-success-container" style="display:none;">
        ...
        <div class="nosuccess" style="display: none;">
            <img src="/mobile/img/icon/error.png" />
        ...
        <div class="pay-btn">
            <a href="/StoBusiness/Indextest/comment?orderno=<?=$orderno?>" type="button" class="am-btn am-btn-danger am-btn-block">完 成</a><!--/index/index/index-->
       <!--  </div>
    </div> -->
...
<script type="text/javascript">
    $(function(){
     ...
     function getStatucs(){
            var orderno = "<?=$orderno?>";
            var url = "/StoBusiness/Indextest/ajaxPayStatus?&orderno="+orderno;
