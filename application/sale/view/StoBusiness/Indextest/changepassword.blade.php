    ...
    $("#sure-btn").on("click",function(){
        ...
        if(!reg.test(paypwd)){
         ...
         $.ajax({
                type:'GET',
                dataType:'json',
                url:"/StoBusiness/Indextest/dochagepassword?customerid=<?=$customerid?>&paypwd=" + paypwd,
                success: function(result){
                    ...
                    if(_data.code == 200){
                        ...
                        window.location.href = "/StoBusiness/Indextest/setpayamount?business_code=<?=$business_code?>";
