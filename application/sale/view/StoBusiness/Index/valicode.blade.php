     ...
     var countdown=60; 
        ...
        function checkvalicode(){
            ...
            $.ajax({
                type:'GET',
                dataType:'json',
                url:"/StoBusiness/Index/checkvalicode?mobile=<?=$realmobile?>&valicode=" + valicode,
                success: function(result){
                    ...
                    if(_data.code == 200){
                        ...
                        window.location.href = "/StoBusiness/Index/changepassword?customerid=<?=$customerid?>&business_code=<?=$business_code?>";
                    }else{
                        layer.open({
                            content: '验证码错误',
                            skin: 'msg',
