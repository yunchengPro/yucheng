    ...
    <div data-am-widget="list_news" class="am-list-news am-list-news-default">
            ...
            <ul class="am-list">
                <li class="am-g am-list-item-dated">
                    <a href="#" class="am-list-item-hd ">
                        <img src="/mobile/img/icon/balance.png" /> 余额支付 <?php if($result['balance'] <= 0){ ?><span class="gray"><?=$result['balanceinfo']?></span><?php } ?>
                    </a>
                ...
                <li class="am-g am-list-item-dated">
                    ...
                    <span class="am-list-date"><i class="icon icon-choose-pay" style="display: none;"></i></span>
                </li>
                <?php }else{?>
                <li class="am-g am-list-item-dated">
                    <a href="##" class="am-list-item-hd ">
        ...
        <div class="pay-for-money am-g">
            ...
            <div class="pay-btn">
                ...
                <a href="javascript:;"  id="pay_ac" type="button" class="am-btn am-btn-danger am-btn-block">确定付款</a><!--/stobusiness/index/paysuccess?storeid=1-->
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#pay_ac").click(function(){
            ...
            //提交订单
            $.get("/StoBusiness/Index/addorder?amount=<?=$trueamount?>&business_code=<?=$business_code?>&customerid=<?=$customerid?>&managerid=<?=$managerid?>&noinvamount=<?=$noinvamount?>&remarks=<?=$remarks?>&sign=<?=$sign?>&hascoust=<?=$hascoust?>&bonusamount=<?=$bonusamount?>&service_code=<?=$service_code?>", function(data){
                data = eval("("+data+")");
                    ...
                    if(typeof pay_code!='undefined' && pay_code!=''){
                        ...
                        <?php if($is_weixin){?>
                                ...
                                if(paytype ==2){
                                    ...
                                    <?php } ?>
                                    topay(pay_code);
                                    //window.location.href="/StoBusiness/Index/paypassword?amount=<?=$amount?>&customerid=<?=$customerid?>&storeid=<?=$storeid?>&orderno="+pay_code;
                                    //balancepay(pay_code);
                                }
        ...
        function alipay(orderno){
            window.location.href="/StoBusiness/Index/aliwappayorder?amount=<?=$trueamount?>&coustamount=<?=$coustamount?>&customerid=<?=$customerid?>&orderno="+orderno;
        }
        
        function quickpay(orderno){
            window.location.href="/StoBusiness/Index/quickpay?customerid=<?=$customerid?>&orderno="+orderno+"&coustamount=<?=$coustamount?>";
        }
        ...
        // if(typeof openid!='undefined' || openid!=''){
            ...
            function callpay(orderno){
                ...
                // }else{
                    ...
                    //alert(openid);
                    //$("#my-modal-loading").modal();
                    var url = "/StoBusiness/Index/callpay?amount=<?=$trueamount?>&coustamount=<?=$coustamount?>&customerid=<?=$customerid?>&openid="+openid+"&orderno="+orderno;
                            ...
                            success:function(data){
                                ...
                                if(_data.code == 200){
                                    ...
                                    if(mymessage==true){  
                                        ...
                                        window.location.href = "/StoBusiness/Index/valicode?customerid="+customerid+"&business_code=<?=$business_code?>";
                                        return false;
                                    }else{ 
                                        layer.open({
                                            content: "已取消",
            ...
            $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(_data.code == 200){
                            ...
                            window.location.href = "/StoBusiness/Index/paysuccess?orderno="+pay_code;
                        }else{
                            // layer.open({
                            //     content: data,
                            //     skin: 'msg',
                            ...
                            // });
                            alert(_data.msg); 
                            window.location.href = "/StoBusiness/Index/setpayamount?business_code=" + business_code; //"/index/index/storeindex?storeid="+storeid;
                        }
                    }
            });
        }
