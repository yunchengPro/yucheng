...
<head>
    ...
    <style>
        ...
        .new-user-wrap .card-wrap{background: url(<?=$publicDomain?>/mobile/img/icon/card_bg.png) center center no-repeat;background-size: 100%;padding: 10px 25px ;}
...
<body class="gift_bg">
    ...
    <form id="setpayamountform" action="" method="post">
        <section class="payInfo-wrap">
            ...
            <div>
                <input type="tel"  id="amount" name="amount" placeholder="询问服务员后输入金额" value="<?=$amount?>"  />
            </div>
            
            <div class="tip">不参与活动金额</div>
            <div>
                <input type="tel" placeholder="询问服务员后输入金额" value="<?=$noinvamount?>" id="noinvamount" name="noinvamount"  />
            </div>
            ...
            <input type="hidden" name="trueamount" id="trueamount" />
            <div class="desc-wrap">
    ...
    <section class="new-user-wrap">
        <div class="card-wrap">
            <div class="text-center mb-10"><span class="user-tip">新用户首次付款验证手机获得立减优惠</span></div>
            <div class="item">
            ...
            <div class="item" style="margin-bottom: 0;">
                ...
                <button class="am-btn am-btn-danger get-code" type="button" id="ko" onclick="settime()">获取验证码</button>
            </div>
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        if(result.code == '200'){
                            ...
                            // alert(disamount);
                            // alert(newamount);
                            $(".pay-money").text(newamount);
                            $("#trueamount").val(newamount);
                            $(".p-2").text(newamount);
                        }else{
        ...
        $("#pay").click(function(){
            ...
            if(customerid == ''){
                ...
                $.ajax({
                    type:'GET',
                    dataType:'json',
                    url:"/StoBusiness/Index/ajaxlogin?mobile=" + mobile + "&valicode=" + valicode,
                    success: function(result){
                        //alert(result);
                        result = eval("("+result+")");
                        //alert(result);
