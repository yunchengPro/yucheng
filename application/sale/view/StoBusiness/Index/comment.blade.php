           ...
           <!--   <div class="am-u-sm-12">
            ...
            <div class="button-group button-group-small radio">   
                ...
                <script type="text/javascript">
                    fileupload('photos','{"url":"\/uploadfile\<?=$publicDomain?>/mobile/jQueryFileUpload.php","domain":"\/\/nnhcoupon.oss-cn-shenzhen.aliyuncs.com\/","maxFileSize":4194304,"maxNumberOfFiles":5,"savefileurl":"\/Sys\/upload\/getfile","getParamUrl":"\/Sys\/upload\/policy","server_type":"NNH\/images","formData":{"server_type":"NNH\/images"}}');
                </script>
            </div>
