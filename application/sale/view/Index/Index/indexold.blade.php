...
<body>
    ...
    <div class="store-header am-g">
        <a href="#" class="am-u-sm-2" ><img src="<?=$business['businesslogo']?>" width="40px" /></a>
        <span class="am-u-sm-8 store-title"><?=$business['businessname']?></span>
      <!--  <a href="login.html" class="am-u-sm-2 share">
            <div class="flex-column gray share-f text-center">
                            ...
                            <a href="/index/index/goodsdetail?goodsid=<?=$v['productid']?>">
                               <div class="pro-dt">
                                    ...
                                    <div class="pro-box-txt">
                                        ...
                                        <div><span class="red"><?=$v['prouctprice']?></span><small>元</small> <?php if($v['bullamount'] > 0){ ?>+<span class="red"><?=$v['bullamount']?></span><small>牛豆</small><?php } ?></div>
