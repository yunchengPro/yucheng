     ...
     var countdown=60; 
               ...
               // return;
                ...
                if(countdown == 60){
                    ...
                    $.ajax({
                        type:'GET',
                        dataType:'json',
                        url:"/StoBusiness/Index/Send?mobile=" + mobile,
        ...
        function checkvalicode(){
            ...
            $.ajax({
                type:'GET',
                dataType:'json',
                url:"/Customer/Index/checkvalicode?mobile=<?=$realmobile?>&valicode=" + valicode,
                success: function(result){
                    ...
                    if(_data.code == 200){
                        ...
                        window.location.href = "/Customer/Index/changepassword?customerid=<?=$customerid?>&role=<?=$role?>&checkcode=<?=$checkcode?>&customercode=<?=$customercode?>";
                    }else{
                        layer.open({
                            content: '验证码错误',
                            skin: 'msg',
