    ...
    $("#sure-btn").on("click",function(){
        ...
        if(!reg.test(paypwd)){
         ...
         $.ajax({
                type:'GET',
                dataType:'json',
                url:"/Customer/Index/dochagepassword?customerid=<?=$customerid?>&paypwd=" + paypwd,
                success: function(result){
                    ...
                    if(_data.code == 200){
                        ...
                        window.location.href = "/Customer/Index/becomeTarent?role=<?=$role?>&checkcode=<?=$checkcode?>&customerid=<?=$customerid?>&customercode=<?=$customercode?>";
