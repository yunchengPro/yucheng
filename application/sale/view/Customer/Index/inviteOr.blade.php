...
<html>
	...
	<body class="invite-nr-bg">
		<div class=""></div>
		<div class="invite-wrap">
			<div class="invite-desc">
				<div>您受邀成为创业牛人，</div>
				<div>开始创业；</div>
				<div class="mg-top">您每邀请一名朋友成为创业牛人，</div>
				<div>可赚取牛票和牛粮，</div>
				<div>并可享创业牛达人得消费分享收益。</div>
			</div>
			<div class="invite-oper">
				<button type="button" class="go-invtite nr-btn">马上接受邀请</button>
			</div>
			<div class="invite-rule">
				<div><strong>活动规则：</strong></div>
				<div>1、牛票在平台可提现可消费；</div>
				<div>2、牛粮在平台的联盟商家消费并获赠牛豆；</div>
				<div>3、享受分享的创业牛人拓展实体店粉丝得全国联盟商家消费分润；</div>
				<div>4、每位牛人最多可拓展6家实体店和6家工厂入驻平台；</div>
