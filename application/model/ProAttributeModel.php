...
class ProAttributeModel {
	...
	public function __construct() {
		$this->_modelObj = Db::Table('ProAttribute');
		$this->_modelObj->_fields = ['attr_name','sort','isdelete'];
	}
    ...
    */
	 ...
	 */
	public function add() {
		$this->_modelObj->_attrName  		= $this->_attrName;
