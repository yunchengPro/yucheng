...
{   
    ...
    public function __construct() {
        $this->_modelObj = Db::Table('ProProductInfo');
        $this->_modelObj->_fields = ['description','filterkeyword','evaluatecount','salecount','scores','lastevaluateid'];
    }
