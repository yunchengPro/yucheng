...
class OrdUserLogisticsInfoModel {
	...
	public function __construct() {
		$this->_modelObj = Db::Table('OrdUserLogisticsInfo');
	}
    ...
    */
     ...
     * 获取收货人全部详细信息
     */
    public function getLogisticsInfo($user_logistics_id) {
        return $this->_modelObj->getRow(["user_logistics_id"=>$user_logistics_id],"*");
    }
    
    /*
     * 获取收货人身份证号码信息
     */
    public function getLogisticsIdnumber($user_logistics_id) {
        return $this->_modelObj->getRow(["user_logistics_id"=>$user_logistics_id],"idnumber");
    }
    ...
    */
	...
	public static function getModelObj() {
		return new OrdUserLogisticsInfoDB();
	}
