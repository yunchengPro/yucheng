...
class SysBonusSettingModel {
	...
	public function __construct() {
		$this->_modelObj = Db::Table('SysBonusSetting');
		 $this->_modelObj->_fields = ['role','adddate','proportion','addtime'];
	}
    ...
    */
	...
	public function add() {
		...
		$this->_modelObj->_adddate  		= $this->_adddate;
		$this->_modelObj->_proportion  		= $this->_proportion;
