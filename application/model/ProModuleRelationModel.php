...
class ProModuleRelationModel {
	...
	public function __construct() {
		$this->_modelObj = Db::Table('ProModuleRelation');
		$this->_modelObj->_fields = ['module_id','type','obj_id','sort'];
	}
    ...
    */
	...
	public function add() {
		...
		$this->_modelObj->_objId  		= $this->_objId;
...
/*
    ...
    */
	...
	public static function getModelObj() {
		return new ProModuleRelationDB();
	}
