...
{   
    ...
    public function __construct() {
        $this->_modelObj = Db::Table('ArtArticleContent');
        $this->_modelObj->_fields = ['keywords','description','content'];
    }
    ...
    */
     ...
     */
    public function add() {
        $this->_modelObj->_keywords       = $this->_keywords;
