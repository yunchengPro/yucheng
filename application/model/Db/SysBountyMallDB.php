...
class SysBountyMallDB extends MysqlDb {

	protected $_tableName = "sys_bounty_mall";
	...
	protected $_disamount	= null;

	protected $_hasamount 	= null;
	...
	public function __construct() {
		$this->_fields = ['amount','disamount','hasamount','addtime'];
	}
