...
class MallHotKeywordsDB extends MysqlDb {

	protected $_tableName = "mall_hot_kewords";
	...
	public function __construct() {
	    $this->_fields = ['type', 'name', 'kewords', 'addtime'];
	...
	public function add() {
		...
		! is_null($this->_kewords) && $data['kewords'] = $this->_kewords;
