...
* @version    $Id: 2017-03-20 11:30:17Z robert zhao $
*/

namespace app\model;
use app\lib\Db;

class AmoFlowCounterModel {
	...
	public function __construct() {
		$this->_modelObj = Db::Table('AmoFlowCounter');
	}
