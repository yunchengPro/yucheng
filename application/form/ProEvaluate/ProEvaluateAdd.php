...
class ProEvaluateAdd extends BaseForm {
	...
	protected function getValidations() {
		return array (
			...
			'businessid' => array (
				array ('is_digits', '商家id必须为数字'),
			),
			'productid' => array (
				array ('is_digits', '商品id必须为数字'),
			),
			'skuid' => array (
				array ('is_digits', '商品sku的id必须为数字'),
			),
			'productname' => array (
			...
			'scores' => array (
				array ('is_digits', '评分必须为数字'),
			),
			'content' => array (
				array ('max_length', 255, '评价内容长度不能超过255'),
			),
			'isanonymous' => array (
				array ('is_digits', '是否匿名必须为数字'),
			),
			'addtime' => array (
			),
			'frommemberid' => array (
				array ('is_digits', '评价会员id必须为数字'),
			),
			...
			'state' => array (
				array ('is_digits', '评价信息的状态 0为正常 1为禁止显示必须为数字'),
			),
			'remark' => array (
				array ('max_length', 255, '管理员对评价的处理备注长度不能超过255'),
			),
			'parentid' => array (
				array ('is_digits', '针对回复的id必须为数字'),
			),
			'rootid' => array (
				array ('is_digits', '根评价id必须为数字'),
			),
			'istop' => array (
				array ('is_digits', '是否置顶必须为数字'),
			),
			'desccredit' => array (
				array ('is_digits', '商品描述评分必须为数字'),
			),
			'servicecredit' => array (
				array ('is_digits', '服务态度评分必须为数字'),
			),
			'deliverycredit' => array (
				array ('is_digits', '发货速度评分必须为数字'),
			),
			'evaluateauto' => array (
				array ('is_digits', '是否自动评价，0为用户评价，1为自动评价必须为数字'),
			),
		);
	}
}?>