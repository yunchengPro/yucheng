...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        ...
        <div class="row-cl">
            <div class="text-c loginTtl">牛商管理系统</div>
        </div>
        <form class="form form-horizontal" action="/Login/Index/doLogin" method="post" id="logform" novalidate="novalidate">
            <div class="row cl">
                <div class="formControls loginnameCotainer">
                    <input  onkeydown="return banInputSapce(event);" onKeyup="return inputSapceTrim(event,this);" id="loginname" name="loginname" placeholder="请输入手机号" onclick="return closemg();" class="size-L input-text loginname" type="text" >
            ...
            <div class="row cl">
                <div class="formControls passwordCotainer">
                    <input  onkeydown="return banInputSapce(event);" onKeyup="return inputSapceTrim(event,this);" id="password" name="password"  placeholder="请输入登录密码" onclick="return closemg();" class="size-L input-text password" type="password">
