...
<?php 
    ...
    */
    ...
    //$field_type ='detail'; //表示以查看详情的方式显示 "validator"=>"required:true" "validator"=>"required:true"

    $field = array(
            "newpwd"=>array("type"=>"password","name"=>"新密码","validator"=>"required:true"),
            "newpwd2"=>array("type"=>"password","name"=>"重复密码","validator"=>"required:true")
        );
