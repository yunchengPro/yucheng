<?php
    ...
    */
	foreach ($pagelist as $key => $row) {
	    $pagelist[$key]['act'][] = array("type" => "newpage", "name" => "button", "value" => "查看", "_width" => "500", "_height" => "400", "_title" => "查看", "_url" => "/Order/Refund/editRefund?id=".Encode($row['id']));
    ...
    */
    ...
    //自动生成按钮
    $export_url = "/Order/Refund/extportindex"; //导出数据的action
?> 
<?php if ($full_page){?>
<!---头部-->
