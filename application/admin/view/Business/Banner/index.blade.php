...
use app\lib\Db;
    ...
    */
    $list_set = array(
        ...
        "urltype"=>array("name"=>"跳转类型", 'data_arr' => ['1' => '原生app', '2'=>'H5']),
        "url"=>array("name"=>"跳转链接"),
    ...
    */
    foreach($pagelist as $key=>$row){
        ...
        $pagelist[$key]['act'][]= array("type"=>"newpage","name"=>"button","value"=>"编辑","_width"=>"550","_height"=>"450","_title"=>"编辑","_url"=>"/Business/Banner/editBanner?id=".Encode($row['id']));

        $pagelist[$key]['act'][]= array("type"=>"confirm","name"=>"button","value"=>"删除","_width"=>"500","_height"=>"200","_title"=>'是否确定删除该记录?',"_url"=>"/Business/Banner/delBanner?ids=".Encode($row['id']));
    ...
    */
    ...
    //自动生成按钮
    $button = array(
            "bt1"=>array("type"=>"popup_listpage","name"=>"button","value"=>"添加广告","_width"=>"550","_height"=>"450","_title"=>'添加广告',"_url"=>"/Business/Banner/addBanner"),

            "bt2"=>array("type"=>"confirm_all","name"=>"button","value"=>"批量删除","_width"=>"500","_height"=>"200","_title"=>'删除选中项?',"_url"=>"/Business/Banner/delBanner?rel=delete")
        );
