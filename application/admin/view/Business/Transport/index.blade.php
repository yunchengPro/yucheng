...
use app\lib\Db;
    ...
    */
    $list_set = array(
        ...
        "transport_type"=>array("name"=>"模板类型", 'data_arr' => ['1' => '商家模板', '2'=>'商品模板']),
...
//        $pagelist[$key]['businessid'] = Db::Model("BusBusiness")->getRow(['id'=>$row['businessid']],'businessname')['businessname'];
        ...
        $pagelist[$key]['act'][]= array("type"=>"newpage","name"=>"button","value"=>"编辑","_width"=>"650","_height"=>"550","_title"=>"编辑<font color='green'>".$row['title']."</font>","_url"=>"/Business/Transport/editTransportExtend?tid=".Encode($row['id']));
        //$pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"编辑","_width"=>"650","_height"=>"550","_title"=>"编辑","_url"=>"/Business/Transport/editTransport?id=".Encode($row['id']));
