...
<?php 
    ...
    */
    ...
    $field = array(
            "title"=>array("type"=>"text","name"=>"运费模板名称","validator"=>"required:true","value"=>$transportData['title']),
            "valuation_type"=>array("type"=>"select", "name"=>"计价方式", "option"=>['1' => '按件数', '2'=>'按重量', '3'=>'按体积'],"validator"=>"required:true", "value"=>$transportData['valuation_type']),
            "transport_type"=>array("type"=>"select", "name"=>"模板类型", "option"=>['1' => '商家模板', '2'=>'商品模板'],"validator"=>"required:true", "value"=>$transportData['transport_type']),
            "id"=>array("type"=>"hidden","value"=>$transportData['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
