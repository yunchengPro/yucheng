...
<?php 
    ...
    */
    ...
    $field = array(
            "businessname"=>array("type"=>"text","name"=>"商家名称","validator"=>"required:true","value"=>$business['businessname']),
            "businesslogo"=>array("type"=>"imgupload","name"=>"商家logo","validator"=>"required:true","value"=>$business['businesslogo']),
            "realname"=>array("type"=>"text","name"=>"负责人姓名","validator"=>"required:true","value"=>$business['realname']),
            "idnumber"=>array("type"=>"text","name"=>"身份证号码","value"=>$business['idnumber']),
            "mobile"=>array("type"=>"text","name"=>"负责人电话","validator"=>"required:true","value"=>$business['mobile']),
            "servicetel"=>array("type"=>"text","name"=>"服务电话","validator"=>"required:true","value"=>$business['servicetel']),
            "area_code"=>array("type"=>"area","name"=>"商家地区","validator"=>"required:true","value"=>$business['area_code']),
            "address"=>array("type"=>"text","name"=>"商家街道地址","validator"=>"required:true","value"=>$business['address']),
            "description"=>array("type"=>"edit","name"=>"商家详细介绍","value"=>$business['description']),
            "id"=>array("type"=>"hidden","value"=>$business['id']),
            "submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
