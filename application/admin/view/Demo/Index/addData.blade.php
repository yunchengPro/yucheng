...
<?php 
    ...
    */
    $action = "/demo/index/getPostData";//定义表单提交的路径
    //$field_type ='detail'; //表示以查看详情的方式显示
    $field = array(
            "name"=>array("type"=>"text","name"=>_("姓名"),"value"=>"测试","head_width"=>"100"),
            "mobile"=>array("type"=>"text","name"=>_("电话"),"validator"=>"required:true,number:true","messages"=>"电话有问题哦"),
            //"title1"=>array("type"=>"title","name"=>"<font color='red'>标题1</font>"),
            "status"=>array("type"=>"select","name"=>_("状态"),"option"=>array("-1"=>"停用","1"=>"启用"),"value"=>"1","validator"=>"required:true"),
            
            "streetname"=>array("type"=>"text","name"=>"街道地址","value"=>"","validator"=>"required:true"),
