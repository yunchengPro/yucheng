<?php
    ...
    */
    ...
    //操作按钮
    $button_str .= Html::button(array("type"=>"confirm","name"=>"button","value"=>"启用","_width"=>"500","_height"=>"200","_title"=>'选中记录标记为启用?',"_url"=>"/demo/linkinfo1/del/id/".Encode('1')))."&nbsp;";
    $button_str .= Html::button(array("type"=>"popup","name"=>"button","value"=>"编辑","_width"=>"700","_height"=>"500","_title"=>"编辑","_url"=>"/demo/index/add/id/".Encode('1')));
