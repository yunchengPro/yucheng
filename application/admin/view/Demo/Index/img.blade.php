...
<?php 
    /*
    说明：
    "f_name"=>array("type"=>"text","name"=>_("姓名")),
    "f_name" 表单名
    ...
    validator 校验表单 以字符串形式定义：
            ...
            remote:{ 
                        ...
                        dataType:"json",
                        data:{  
                            f_productcode:function(){return $("#f_productcode").val();},
                            id:  function(){return $("#f_productcode").attr("enctype");}
                        }
                    }
    ...
    */
    ...
    $field = array(
            "f_name"=>array("type"=>"text","name"=>"姓名","value"=>"测试","validator"=>"required:true","messages"=>"姓名不能为空哦","head_width"=>"100"),
            "f_mobile"=>array("type"=>"text","name"=>"电话","validator"=>"required:true,number:true","messages"=>"电话有问题哦"),
            //"title1"=>array("type"=>"title","name"=>"<font color='red'>标题1</font>"),
            "f_type"=>array("type"=>"select","name"=>"类型","option"=>array("1"=>"类型1","2"=>"类型2","3"=>"类型3"),"value"=>"1","validator"=>"required:true"),
            
            "f_time"=>array("type"=>"time","name"=>"时间","value"=>"2016-01-01","validator"=>"required:true"),
            "f_times"=>array("type"=>"times","name"=>"时间范围","start_value"=>"2016-01-01","end_value"=>"2016-01-02","validator"=>"required:true"),
            //"f_area"=>array("type"=>"area","name"=>"地区","value"=>"230303"),
            "f_img1"=>array("type"=>"imgupload","name"=>"图片1","validator"=>"required:true"),
            //"f_img2"=>array("type"=>"imgupload","name"=>"图片2","options"=>array("maxNumberOfFiles"=>2)),
            "f_radio"=>array("type"=>"radio","name"=>"raido控件","terms"=>array("1"=>"选项1","2"=>"选项2"),"value"=>"2"),
            "f_checkbox"=>array("type"=>"checkbox","name"=>"checkbox控件","terms"=>array("1"=>"选项1","2"=>"选项2","3"=>"选项3"),"value"=>"1,3","validator"=>"required:true,minlength:1"), //value也可以为数组
            "f_textarea"=>array("type"=>"textarea","name"=>"内容项","value"=>"123","validator"=>"required:true"),
            "f_edit"=>array("type"=>"edit","name"=>"编辑内容","width"=>"300","height"=>"200","value"=>"11122","validator"=>"required:true"),
