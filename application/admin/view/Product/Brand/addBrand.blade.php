...
<?php 
    ...
    */
    ...
    $field = array(
            "brandname"=>array("type"=>"text","name"=>"品牌名称","validator"=>"required:true","value"=>$brandData['brandname']),
            "brandlogo"=>array("type"=>"imgupload","name"=>"品牌logo","validator"=>"required:true","value"=>$brandData['brandlogo']),
            "remark"=>array("type"=>"text","name"=>"品牌描述","value"=>$brandData['remark']),
            "country"=>array("type"=>"text","name"=>"国际编号","validator"=>"required:true","value"=>$brandData['country']),
            "company"=>array("type"=>"text","name"=>"所属公司","validator"=>"required:true","value"=>$brandData['company']),
            "sort"=>array("type"=>"text","name"=>"排序","validator"=>"required:true","value"=>$brandData['sort']),
            "id"=>array("type"=>"hidden","value"=>$brandData['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
