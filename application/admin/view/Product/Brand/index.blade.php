...
use app\lib\Db;
    ...
    */
    $list_set = array(
        ...
        "brandlogo"=>array("name"=>"品牌图标","thumb"=>['width'=>50,'height'=>35]),
        "remark"=>array("name"=>"描述"),
    ...
    */
    foreach($pagelist as $key=>$row){
        ...
        $pagelist[$key]['act'][]= array("type"=>"popup_listpage","name"=>"button","value"=>"编辑","_width"=>"550","_height"=>"450","_title"=>"编辑","_url"=>"/Product/Brand/editBrand?id=".Encode($row['id']));
