...
<?php 
    ...
    */
    ...
    $field = array(
            "attr_name"=>array("type"=>"text","name"=>"规格名称","validator"=>"required:true","value"=>$attrbuteData['attr_name']),
            "sort"=>array("type"=>"text","name"=>"排序","validator"=>"required:true","value"=>$attrbuteData['sort']),
            "id"=>array("type"=>"hidden","value"=>$attrbuteData['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
