...
<?php 
    ...
    */
    ...
    $field = array(
            "parent_id"=>array("type"=>"select","name"=>"上级分类","option"=>$category,"value"=>$localCategory['parent_id']),
            "category_name"=>array("type"=>"text","name"=>"分类名称","validator"=>"required:true","value"=>$localCategory['category_name']),
            "sort"=>array("type"=>"text","name"=>"排序","value"=>$localCategory['sort'],"validator"=>"required:true"),
            // "category_icon"=>array("type"=>"imgupload","name"=>"分类图标","validator"=>"required:true","value"=>$localCategory['category_icon']),
            "id"=>array("type"=>"hidden","value"=>$localCategory['id']),
            //"submit"=>array("type"=>"submit","name"=>"提交"), //加该参数表示独立页面，不加该参数表示弹窗
        );
