...
<article class="page-container page-container-add" id="tab-set">
   ...
   <div class="row cl">
        <div class="col-xs-8 col-sm-6 col-xs-offset-4 ">
            <button class="btn btn-danger "  type="submit"  >&nbsp;<?php echo $submit_arr['name']!=''?$submit_arr['name']:'确定';?>&nbsp;</button>
        &nbsp;<?=$submit_arr['other']?>
        </div>
    </div>
...
<div class="popwinbottom" >
    ...
    <button class="btn btn-danger bg-main button-small"  type="submit"  >&nbsp;确定&nbsp;</button>
    <?php }?>
    <?php if(!isset($noshowClose)||$noshowClose!=1){?>
        <button class="btn btn-close mr-10"  type="button"  id="closewin">&nbsp;关闭&nbsp;</button>
    <?php }?>
</div>
<?php }?>
</form>
